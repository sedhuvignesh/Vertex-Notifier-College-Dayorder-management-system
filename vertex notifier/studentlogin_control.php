            ...
            <div class="col-md-9 content">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h1 class="mb-0">STUDENT LOGIN CONTROL</h1>
                    </div>
                    <div class="card-body">
                        <div class="btn-container">
                            <a href="add_studentlogin.php" class="btn btn-success text-light">Add New</a>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href='edit_studentlogin.php?edit=<?php echo $username ?>' class="btn btn-success text-light">Edit</a>
                                            <a href='delete_studentlogin.php?del=<?php echo $username ?>' class="btn btn-danger text-light">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $id++; } ?>
